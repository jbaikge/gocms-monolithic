...
func NewMemory() Repository {
	return &memoryRepository{
		classes:   make([]gocms.Class, 0, 128),
		documents: make([]gocms.Document, 0, 128),
	}
}
...
func (r *memoryRepository) GetAllClasses() ([]gocms.Class, error) {
	sort.Sort(sortClasses(r.classes))
	return r.classes, nil
}

func (r *memoryRepository) GetClassById(id primitive.ObjectID) (class gocms.Class, err error) {
...
func (r *memoryRepository) GetClassBySlug(slug string) (class gocms.Class, err error) {
	for _, c := range r.classes {
		if c.Slug == slug {
			return c, nil
		}
...
func (r *memoryRepository) InsertClass(class *gocms.Class) (err error) {
...
func (r *memoryRepository) UpdateClass(class *gocms.Class) (err error) {
...
func (r *memoryRepository) GetChildDocumentBySlug(parentId primitive.ObjectID, slug string) (doc gocms.Document, err error) {
...
func (r *memoryRepository) GetClassDocumentBySlug(classId primitive.ObjectID, slug string) (doc gocms.Document, err error) {
	for _, d := range r.documents {
...
func (r *memoryRepository) GetDocumentList(params gocms.DocumentListParams) (list gocms.DocumentList, err error) {
	docs := make([]gocms.Document, 0, len(r.documents))
...
func (r *memoryRepository) GetDocumentById(id primitive.ObjectID) (doc gocms.Document, err error) {
	for _, d := range r.documents {
		if d.Id == id {
			return d, nil
		}
...
func (r *memoryRepository) InsertDocument(doc *gocms.Document) (err error) {
...
func (r *memoryRepository) UpdateDocument(doc *gocms.Document) (err error) {
